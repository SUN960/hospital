...
insert into sys_dict_type values(11,  '动物性别', 'sys_user_sex1',        '0', 'admin', sysdate(), '', null, '动物性别列表');
...
insert into sys_dict_data values(29,  1,  '雄',       '0',       'sys_user_sex1',        '',   '',        'Y', '0', 'admin', sysdate(), '', null, '性别雄');
insert into sys_dict_data values(30,  2,  '雌',       '1',       'sys_user_sex1',        '',   '',        'N', '0', 'admin', sysdate(), '', null, '性别雌');
insert into sys_dict_data values(31,  3,  '未知',     '2',       'sys_user_sex1',        '',   '',        'N', '0', 'admin', sysdate(), '', null, '性别未知');
