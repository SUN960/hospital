    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['hospital:order:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hospital:order:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hospital:order:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="政策减免" prop="policy">
          <el-input v-model="form.policy" placeholder="请输入政策减免" />
        </el-form-item>
        <el-form-item label="其它费用" prop="otherCost">
          <el-input v-model="form.otherCost" placeholder="请输入其它费用" />
        </el-form-item>
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/hospital/order";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除预约订单编号为"' + orderIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hospital/order/export', {
        ...this.queryParams
